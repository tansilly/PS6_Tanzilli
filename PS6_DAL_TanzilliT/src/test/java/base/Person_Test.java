...
public class Person_Test {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		Date dDate = null;
		try {
			dDate = new SimpleDateFormat("yyyy-MM-dd").parse("1995-12-02");
		} catch (ParseException e) {
			e.printStackTrace();
		}
		
		per1 = new PersonDomainModel();
		per1.setFirstName("Tim");
		per1.setLastName("Tanzilli");
		per1.setBirthday(dDate);
		per1.setCity("Wilmington");
		per1.setPostalCode(19808);
		per1.setStreet("1234 West Street");
	}
